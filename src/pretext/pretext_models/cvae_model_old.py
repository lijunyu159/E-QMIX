...
class CVAECoordinationPatterns(nn.Module):
    ...
    def forward(self, inputs, rnn_hxs_encoder, rnn_hxs_decoder, seq_len):
        # encoder
        z_mean, z_log_var, rnn_hxs_encoder = self.encoder(inputs, rnn_hxs_encoder, seq_len)
        # z.shape = B*N, N
...
class Encoder(nn.Module):
    ...
    def forward(self, inputs, rnn_hxs, seq_len):
        ...
        x, rnn_hxs = self.base.forward(inputs, rnn_hxs, seq_len)
